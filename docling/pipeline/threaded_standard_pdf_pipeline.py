...
from docling.models.factories import get_ocr_factory, get_table_structure_factory
...
class ThreadedStandardPdfPipeline(ConvertPipeline):
    ...
    def _init_models(self) -> None:
        ...
        self.table_model = self._make_table_structure_model(art_path)
    ...
    def _make_table_structure_model(self, art_path: Optional[Path]) -> Any:
